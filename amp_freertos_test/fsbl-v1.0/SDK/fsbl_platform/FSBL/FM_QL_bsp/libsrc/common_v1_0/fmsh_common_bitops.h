...
/****d* include.bitops/FMSH_BIT_WIDTH
 * DESCRIPTION
...
/****d* include.bitops/FMSH_BIT_OFFSET
 * DESCRIPTION
 ...
 * SOURCE
 */
#define FMSH_BIT_OFFSET(__bfws)   ((uint32_t) (bfo ## __bfws))
/*****/

/****d* include.bitops/FMSH_BIT_MASK
 * DESCRIPTION
 ...
 * SOURCE
 */
#define FMSH_BIT_MASK(__bfws) ((uint32_t) (((bfw ## __bfws) == 32) ?  \
        0xFFFFFFFF : ((1U << (bfw ## __bfws)) - 1)) << (bfo ## __bfws))
/*****/

/****d* include.bitops/FMSH_BIT_CLEAR
 * DESCRIPTION
...
/****d* include.bitops/FMSH_BIT_GET_UNSHIFTED
 * DESCRIPTION
...
/****d* include.bitops/FMSH_BIT_SET_NOREAD
 * DESCRIPTION
 *  Place the specified value into the specified bits of a word of data
...
/****d* include.bitops/FMSH_BIT_BUILD
 * DESCRIPTION
