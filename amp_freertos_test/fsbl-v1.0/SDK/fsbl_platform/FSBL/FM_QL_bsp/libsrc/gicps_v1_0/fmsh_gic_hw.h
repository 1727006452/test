 ...
 */
#define FGicPs_MAX_INTR_PRIO_VAL    	32U
 ...
 * @{
 */
#define FGicPs_DIST_EN_OFFSET		0x00000000U /**< Distributor Enable
							Register */
#define FGicPs_IC_TYPE_OFFSET		0x00000004U /**< Interrupt Controller
							Type Register */
#define FGicPs_DIST_IDENT_OFFSET	0x00000008U /**< Implementor ID
							Register */
#define FGicPs_SECURITY_OFFSET		0x00000080U /**< Interrupt Security
							Register */
#define FGicPs_ENABLE_SET_OFFSET	0x00000100U /**< Enable Set
							Register */
#define FGicPs_DISABLE_OFFSET		0x00000180U /**< Enable Clear Register */
#define FGicPs_PENDING_SET_OFFSET	0x00000200U /**< Pending Set
							Register */
#define FGicPs_PENDING_CLR_OFFSET	0x00000280U /**< Pending Clear
							Register */
...
#define FGicPs_SPI_TARGET_OFFSET	0x00000800U /**< SPI Target
							Register 0x800-0x8FB */
#define FGicPs_INT_CFG_OFFSET		0x00000C00U /**< Interrupt Configuration
							Register 0xC00-0xCFC */
#define FGicPs_PPI_STAT_OFFSET		0x00000D00U /**< PPI Status Register */
#define FGicPs_SPI_STAT_OFFSET		0x00000D04U /**< SPI Status Register
							0xd04-0xd7C */
#define FGicPs_AHB_CONFIG_OFFSET	0x00000D80U /**< AHB Configuration
							Register */
#define FGicPs_SFI_TRIG_OFFSET		0x00000F00U /**< Software Triggered
							Interrupt Register */
 ...
 * @{
 */
#define FGicPs_LSPI_MASK	0x0000F800U /**< Number of Lockable
						Shared Peripheral
						Interrupts*/
 ...
 * @{
 */
#define FGicPs_INT_NS_MASK	0x00000001U /**< Each bit corresponds to an
						INT_ID */
/* @} */
 ...
 * @{
 */
#define FGicPs_INT_EN_MASK	0x00000001U /**< Each bit corresponds to an
						INT_ID */
/* @} */
 ...
 * @{
 */
#define FGicPs_INT_CLR_MASK	0x00000001U /**< Each bit corresponds to an
						INT_ID */
/* @} */
 ...
 * @{
 */
#define FGicPs_PEND_SET_MASK	0x00000001U /**< Each bit corresponds to an
						INT_ID */
/* @} */
 ...
 * @{
 */
#define FGicPs_PEND_CLR_MASK	0x00000001U /**< Each bit corresponds to an
						INT_ID */
/* @} */
 ...
 * @{
 */
#define FGicPs_ACTIVE_MASK	0x00000001U /**< Each bit corresponds to an
					      INT_ID */
/* @} */
 ...
 * @{
 */
#define FGicPs_PRIORITY_MASK	0x000000FFU /**< Each Byte corresponds to an
						INT_ID */
#define FGicPs_PRIORITY_MAX	0x000000FFU /**< Highest value of a priority
 ...
 * @{
 */
#define FGicPs_SPI_N_MASK    0x00000001U    /**< Each bit corresponds to an SPI
					     input */
/* @} */
 ...
 * @{
 */
#define FGicPs_AHB_END_MASK       0x00000004U    /**< 0-GIC uses little Endian,
                                                  1-GIC uses Big Endian */
#define FGicPs_AHB_ENDOVR_MASK    0x00000002U    /**< 0-Uses CFGBIGEND control,
...
#define FGicPs_SFI_TRIG_INTID_MASK	0x0000000FU    /**< Set to the INTID
                                                        signaled to the CPU*/
/* @} */
 ...
 * @{
 */
#define FGicPs_CONTROL_OFFSET		0x00000000U /**< CPU Interface Control
							Register */
...
#define FGicPs_HI_PEND_OFFSET		0x00000018U /**< Highest Pending Interrupt
							Register */
#define FGicPs_ALIAS_BIN_PT_OFFSET	0x0000001CU /**< Aliased non-Secure
