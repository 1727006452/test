...
/* CMD Response flag */
#define CMD_RES_FLAG_DATALINE   0x01 /* transferred on dataline */
#define CMD_RES_FLAG_NOCRC      0x02 /* no crc check */
#define CMD_RES_FLAG_RDATA      0x04 /* data read */
#define CMD_RES_FLAG_WDATA      0x08 /* data write */
